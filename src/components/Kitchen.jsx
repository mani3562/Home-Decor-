...
function Kitchen() {
  return (
    <div className='root-k'>
      <div className='main-k'>
      <Navbar/>
      <div className='cent-l'>
      <h2 id='li-ro' >Kitchen</h2>
      ...
      <div class="item1">
            ...
            <img id='arch-img-k' src="./kitchen img/furnished-kitchen.jpg" alt=''/>
        ...
        <div className='grid-items'>
          ...
          <h2>Taciti hendrerit dis odit incidunt</h2>
            <a id='up-date' href='/'  >November 21, 2017 / Kitchen</a>
            <img className='img-items' src='./kitchen_img/pic26-free-img.jpg' alt=''/>
          ...
          <div className='item'>
          <h2>Sodales arcu consequatur consectetur</h2>
            <a id='up-date' href='/' > August 8, 2017 / Kitchen</a>
            <img className='img-items' src="./kitchen_img/pic08-free-img.jpg" alt=''/>
          ...
          <div className='item'>
          <h2>Imperdiet phasellus aliquam</h2>
            <a id='up-date' href='/'> June 20, 2017 / Kitchen, Living Room, Reading Room</a>
            <img className='img-items' src="./kitchen_img/hero01-free-img-1024x647.jpg" alt=''/>
          ...
          <div className='item'>
          <h2>Impedit sit.!</h2>
            <a id='up-date' href='/'> October 5, 2010 / kitchen</a>
            <img className='img-items' src='./kitchen_img/furnished-kitchen.jpg' alt=''/>
        ...
        <div class="pages">
            ...
            <a  href="/">2</a>
            <a  href="/">3</a> */}
            <a  class="next page-numbers" href="/outdoor">Next Page <span class="ast-right-arrow">→</span></a>
        </div>
      </div>
